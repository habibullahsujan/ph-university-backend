...
const adminNameUpdateValidationSchema = z.object({
  ...
  const adminUpdateValidationSchema = z.object({
    body: z.object({
      password: z.string().optional(),
      admin: z.object({
        name: adminNameUpdateValidationSchema,
        gender: z.enum(['male', 'female']).optional(),
        dateOfBirth: z.string().optional(), // You might want to add a regex pattern to validate the date format
